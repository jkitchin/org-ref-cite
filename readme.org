...
Suppose you just want a completing-read compatible inserter using bibtex-completion for candidates. Here is a function that can be used instead of org-cite-basic--complete-key.
...
Now you are all set, no ivy dependency required.
