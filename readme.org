...
Now you are all set, you get bibtex-completion candidates and no ivy dependency required.

If you use helm you press return to select candidates, and then you have to press C-S-return to end the selection and insert the candidates.

If you use ivy-mode you still type return to select candidates, but you have to press C-M-return to end the selection and insert the candidates.

If you use vanilla emacs on this, it is very tedious. You have to press Tab to see any candidates, use arrows to get to the one you want, press return to select it, repeat for additional candidates, and then press return at the end to insert them. If you have a lot of candidates, you really need something like helm/ivy/selectrum, etc. to help with the selection.
